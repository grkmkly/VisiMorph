namespace VisiMorph
{
    partial class Histogram
    {
        ...
        private void InitializeComponent()
        {
            ...
            chartArea1.AxisX.Title = "Renk değerleri";
            ...
            chartArea1.AxisY.Title = "Renk Frekansı";
            chartArea1.BackColor = Color.FromArgb(64, 64, 64);
            chartArea1.Name = "ChartArea1";
            chart.ChartAreas.Add(chartArea1);
            chart.Location = new Point(296, 12);
            chart.Name = "chart";
            series1.ChartArea = "ChartArea1";
            series1.Color = SystemColors.MenuHighlight;
            series1.CustomProperties = "MaxPixelPointWidth=200, MinPixelPointWidth=1, PixelPointWidth=1";
